...
%colordef(gcf, 'black');
h = plot(x, y, 'o', xx, yy, '-');
set(h(1), 'linewidth', 3, 'markersize', 10);
set(h(2), 'linewidth', 3);
fitH = h(1);
curveH = h(2);
axis(limit);
...
verticalH = line([nan nan], [min(y)-1 max(y)+1], 'color', 'k');
circleH = line(nan, nan, 'color', 'k', 'marker', 'o', 'linewidth', 3, 'markersize', 10);
firstH  = line(xx, nan*xx, 'color', 'g', 'linewidth', 3, 'linestyle', ':');
secondH = line(xx, nan*xx, 'color', 'c', 'linewidth', 3, 'linestyle', '-.');
thirdH  = line(xx, nan*xx, 'color', 'r', 'linewidth', 3, 'linestyle', '--');
AxisH = gca; FigH = gcf;
