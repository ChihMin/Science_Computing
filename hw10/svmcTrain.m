...
%		opt=svmcTrain('defaultOpt') returns the default options for SVM. You can modify the options if necessary, and send the options for training a SVM: <p><tt>cPrm=svmcTrain(DS, opt)</tt>
